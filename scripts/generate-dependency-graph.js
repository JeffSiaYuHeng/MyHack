...
function generateWithMadge(rootDir) {
    ...
    try {
        ...
        return processRawGraph(rawGraph);
    } catch (error) {
 ...
 */
function processRawGraph(rawGraph) {
...
function main() {
    ...
    const outputPath = path.join(rootDir, 'DB_Module', '_DOCS', '06_DEPENDENCY_GRAPH.md');
